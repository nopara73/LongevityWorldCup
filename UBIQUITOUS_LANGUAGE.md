...
- **Pheno Age**, **Bortz Age**, and **Crowd Age** are distinct clocks/views. Calculator rank previews use only the selected clock's field. Pheno and Bortz competition ranks compare age reduction, not raw biological age. Profile competition links show Ultimate League and add a second view only if its global rank is strictly better than the Ultimate League rank. Select the lowest global rank among eligible Bortz Age, Pheno Age, Bortz Improvement, Pheno Improvement, and Crowd Age views, using that order for equal ranks. A tie with Ultimate League shows Ultimate League alone. Tracks, demographic leagues, flags, and pace-of-aging statistics do not compete for this second link. Default sharing uses Ultimate League rank.
