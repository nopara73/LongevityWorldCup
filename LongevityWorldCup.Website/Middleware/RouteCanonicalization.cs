namespace LongevityWorldCup.Website.Middleware
{
    internal static class RouteCanonicalization
    {
        ...
        private static readonly Dictionary<string, string> CanonicalAliases = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["/longevitymaxxing"] = "/longevitymaxxing",
            ["/longevitymaxxing/longevitymaxxing"] = "/longevitymaxxing",
            ["/longevitymaxxing/longevitymaxxing.html"] = "/longevitymaxxing",
            ["/helstab-kihivas"] = "/helstab-kihivas",
            ["/helstab-kihivas/helstab-kihivas"] = "/helstab-kihivas",
            ["/helstab-kihivas/helstab-kihivas.html"] = "/helstab-kihivas",
            ["/media"] = "/media",
            ["/misc-pages/media"] = "/media",
            ["/misc-pages/media.html"] = "/media",
            ["/about"] = "/about",
            ["/misc-pages/about"] = "/about",
            ["/misc-pages/about.html"] = "/about",
            ["/history"] = "/history",
            ["/misc-pages/history"] = "/history",
            ["/misc-pages/history.html"] = "/history",
            ["/ruleset"] = "/ruleset",
            ["/rules"] = "/ruleset",
            ["/misc-pages/ruleset"] = "/ruleset",
            ["/misc-pages/ruleset.html"] = "/ruleset",
            ["/privacy"] = "/privacy",
