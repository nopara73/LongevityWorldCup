(function () {
    ...
    function countFlagUsage(athletes, flagAccessor = getAthleteFlag) {
        ...
        const athleteValues = Array.isArray(athletes) ? athletes : [];
        athleteValues.forEach(value => {
            if (!isFlagAthlete(value))
                return;
            const athlete = value;
