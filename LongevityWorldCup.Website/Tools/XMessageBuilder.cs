...
public static class XMessageBuilder
{
    ...
    private static string BuildAthleteCountMilestoneLine(int count, string countLabel)
    {
        return count switch
        {
            ...
            200 => $"{countLabel} athletes are now on the leaderboard, another clean round-number checkpoint.",
            222 => $"{countLabel} athletes are now on the leaderboard, perfectly doubled.",
            250 => $"{countLabel} athletes are now on the leaderboard, a quarter-K field.",
            ...
            1500 => $"{countLabel} athletes are now on the leaderboard, a serious mid-field checkpoint.",
            ...
            2048 => $"{countLabel} athletes are now on the leaderboard, power-of-two checkpoint unlocked.",
            2222 => $"{countLabel} athletes are now on the leaderboard, twos all the way down.",
            2500 => $"{countLabel} athletes are now on the leaderboard, halfway from 2K to 3K.",
            3000 => $"{countLabel} athletes are now on the leaderboard, another thousand-athlete checkpoint.",
            ...
            4000 => $"{countLabel} athletes are now on the leaderboard, clearing the 4K checkpoint.",
            ...
            7500 => $"{countLabel} athletes are now on the leaderboard, three quarters of the way to 10K.",
