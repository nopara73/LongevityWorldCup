...
namespace LongevityWorldCup.Website.Tools
{
    ...
    public static class BortzAgeHelper
    {
        ...
        public static readonly BortzFeature[] Features =
        {
            ...
            new("urea", "Urea", 5.3547152, -0.029554872, Cap: 9.3, CapMode: CapMode.Ceiling),
            new("cholesterol", "Total cholesterol", 5.6177437, -0.0805656, Cap: 7.58, CapMode: CapMode.Ceiling),
            new("creatinine", "Creatinine", 71.565605, -0.01095746), // no cap: PhenoAge has floor, Bortz would need ceiling
            new("cystatin_c", "Cystatin C", 0.900946, 1.859556436, Cap: 0.38, CapMode: CapMode.Floor),
            new("hba1c", "Hemoglobin A1c (HbA1c)", 35.4785711, 0.018116675, Cap: 26, CapMode: CapMode.Floor),
            ...
            new("rbc", "Red blood cell count", 4.4994648, -0.204442153, Cap: 5.77, CapMode: CapMode.Ceiling),
            ...
            new("monocyte_count", "Monocytes", 0.4746987, 0.36937314, Cap: 0.3, CapMode: CapMode.Floor),
            new("neutrophil_count", "Neutrophils", 4.1849454, 0.06679092, Cap: 2, CapMode: CapMode.Floor),
            new("lymphocyte_percentage", "Lymphocytes (%)", 28.5817604, -0.0108158, Cap: 60, CapMode: CapMode.Ceiling),
            new("alt", "Alanine aminotransferase", 3.077868, -0.312442261, IsLog: true, Cap: 29, CapMode: CapMode.Ceiling),
            new("shbg", "Sex hormone-binding globulin (SHBG)", 3.8202787, 0.292323186, IsLog: true),
            new("vitamin_d", "Vitamin D (25-OH)", 3.6052878, -0.265467867, IsLog: true, Cap: 112.6, CapMode: CapMode.Ceiling),
            new("glucose", "Glucose", 4.9563054, 0.032171478, Cap: 4.44, CapMode: CapMode.Floor),
            new("mch", "Mean corpuscular hemoglobin", 31.8396206, 0.02746487, Cap: 25.7, CapMode: CapMode.Floor),
