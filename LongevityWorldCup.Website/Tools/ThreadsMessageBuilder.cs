...
public static class ThreadsMessageBuilder
{
    ...
    private static string BuildAthleteCountMilestoneLine(int count, string countLabel)
    {
        return count switch
        {
            ...
            200 => $"{countLabel} athletes are now on the leaderboard. Clean round-number checkpoint.",
            222 => $"{countLabel} athletes are now on the leaderboard. Perfectly doubled.",
            250 => $"{countLabel} athletes are now on the leaderboard. Quarter-K field.",
            ...
            1500 => $"{countLabel} athletes are now on the leaderboard. Serious mid-field checkpoint.",
            ...
            4000 => $"{countLabel} athletes are now on the leaderboard. 4K checkpoint cleared.",
