...
public static partial class HtmlAssetPlaceholders
{
    private static readonly FrozenDictionary<string, string> Paths = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["{{ASSET_HOMEPAGE_CSS}}"] = "/css/homepage.css",
        ["{{ASSET_HOMEPAGE_JS}}"] = "/js/homepage.js",
        ["{{ASSET_SITE_HEADER_CSS}}"] = "/css/site-header.css",
        ["{{ASSET_SITE_HEADER_JS}}"] = "/js/site-header.js",
        ["{{ASSET_SITE_FOOTER_CSS}}"] = "/css/site-footer.css",
        ["{{ASSET_SITE_FOOTER_JS}}"] = "/js/site-footer.js",
        ["{{ASSET_LEADERBOARD_CONTENT_CSS}}"] = "/css/leaderboard-content.css",
        ["{{ASSET_LEADERBOARD_PAGE_JS}}"] = "/js/leaderboard-page.js",
        ["{{ASSET_LEADERBOARD_EMBED_LISTENER_JS}}"] = "/js/leaderboard-embed-listener.js",
        ["{{ASSET_GUESS_MY_AGE_CSS}}"] = "/css/guess-my-age.css",
        ["{{ASSET_GUESS_MY_AGE_JS}}"] = "/js/guess-my-age.js",
        ...
        ["{{ASSET_SUB_PROGRESS_BAR_JS}}"] = "/js/sub-progress-bar.js",
        ["{{ASSET_ATHLETE_DIALOG_LEADERBOARD_CONTENT_CSS}}"] = "/css/athlete-dialog/leaderboard-content.css",
        ["{{ASSET_ATHLETE_DIALOG_GUESS_MY_AGE_CSS}}"] = "/css/athlete-dialog/guess-my-age.css",
        ["{{ASSET_ATHLETE_DIALOG_AGE_VISUALIZATION_CSS}}"] = "/css/athlete-dialog/age-visualization.css",
