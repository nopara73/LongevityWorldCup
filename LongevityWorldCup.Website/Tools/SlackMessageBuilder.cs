...
public static class SlackMessageBuilder
{
    ...
    private static string MilestoneMessage(int n, string C)
    {
        switch (n)
        {
            ...
            case 200: return $"The competition reached {C} athletes";
            case 222: return $"{C} athletes - perfectly doubled ✌️";
            case 250: return $"The competition reached {C} athletes";
            ...
            case 500: return $"The competition reached {C} athletes";
            ...
            case 1000: return $"The competition reached {C} athletes";
            ...
            case 1500: return $"The competition reached {C} athletes";
            case 1618: return $"Golden-ratio vibes at {C} in the competition 🌀";
            case 2000: return $"The competition reached {C} athletes";
            case 2048: return $"{C} athletes - power-of-two territory 💻";
            case 2222: return $"{C} athletes - twos all the way down ✌️";
            case 2500: return $"The competition reached {C} athletes";
            case 3000: return $"The competition reached {C} athletes";
            case 3141: return $"Slice of π, {C} now on the board 🥧";
            case 3333: return $"Repeating digits, serious field: {C} athletes 🔢";
            case 4000: return $"The competition reached {C} athletes";
            case 4444: return $"{C} athletes - four-four-four-four and still found 🔎";
            case 5000: return $"The competition reached {C} athletes";
            case 5555: return $"Repeating fives, {C} athletes on the leaderboard 🔢";
            case 6969: return $"Meme tier unlocked, {C} competitors 🔓";
            case 7500: return $"The competition reached {C} athletes";
            ...
            case 10000: return $"The competition reached {C} athletes";
