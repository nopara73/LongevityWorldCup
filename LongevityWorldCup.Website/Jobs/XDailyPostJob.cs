...
public class XDailyPostJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        if (await XDailyPostJobTempTestHelper.TryPostTemporaryBadgeAwardPhenoAgeBestImprovementTestAsync(_events, _athletes, _xEvents, _images, _xApiClient, _logger))
            return;
