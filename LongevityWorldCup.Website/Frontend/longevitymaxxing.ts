(function () {
    ...
    interface DiscussionReplyDeletePayload {
        accessToken: string;
        replyId: string;
    }
...
const TIME_ZONE_COUNTRY_DATA = "Europe/Andorra=AD|Asia/Dubai=AE|Asia/Kabul=AF|America/Antigua=AG|America/Anguilla=AI|Europe/Tirane=AL|Asia/Yerevan=AM|Africa/Luanda=AO|Antarctica/McMurdo=AQ|Antarctica/Casey=AQ|Antarctica/Davis=AQ|Antarctica/DumontDUrville=AQ|Antarctica/Mawson=AQ|Antarctica/Palmer=AQ|Antarctica/Rothera=AQ|Antarctica/Syowa=AQ|Antarctica/Troll=AQ|Antarctica/Vostok=AQ|America/Argentina/Buenos_Aires=AR|America/Argentina/Cordoba=AR|America/Argentina/Salta=AR|America/Argentina/Jujuy=AR|America/Argentina/Tucuman=AR|America/Argentina/Catamarca=AR|America/Argentina/La_Rioja=AR|America/Argentina/San_Juan=AR|America/Argentina/Mendoza=AR|America/Argentina/San_Luis=AR|America/Argentina/Rio_Gallegos=AR|America/Argentina/Ushuaia=AR|Pacific/Pago_Pago=AS|Europe/Vienna=AT|Australia/Lord_Howe=AU|Antarctica/Macquarie=AU|Australia/Hobart=AU|Australia/Melbourne=AU|Australia/Sydney=AU|Australia/Broken_Hill=AU|Australia/Brisbane=AU|Australia/Lindeman=AU|Australia/Adelaide=AU|Australia/Darwin=AU|Australia/Perth=AU|Australia/Eucla=AU|America/Aruba=AW|Europe/Mariehamn=AX|Asia/Baku=AZ|Europe/Sarajevo=BA|America/Barbados=BB|Asia/Dhaka=BD|Europe/Brussels=BE|Africa/Ouagadougou=BF|Europe/Sofia=BG|Asia/Bahrain=BH|Africa/Bujumbura=BI|Africa/Porto-Novo=BJ|America/St_Barthelemy=BL|Atlantic/Bermuda=BM|Asia/Brunei=BN|America/La_Paz=BO|America/Kralendijk=BQ|America/Noronha=BR|America/Belem=BR|America/Fortaleza=BR|America/Recife=BR|America/Araguaina=BR|America/Maceio=BR|America/Bahia=BR|America/Sao_Paulo=BR|America/Campo_Grande=BR|America/Cuiaba=BR|America/Santarem=BR|America/Porto_Velho=BR|America/Boa_Vista=BR|America/Manaus=BR|America/Eirunepe=BR|America/Rio_Branco=BR|America/Nassau=BS|Asia/Thimphu=BT|Africa/Gaborone=BW|Europe/Minsk=BY|America/Belize=BZ|America/St_Johns=CA|America/Halifax=CA|America/Glace_Bay=CA|America/Moncton=CA|America/Goose_Bay=CA|America/Blanc-Sablon=CA|America/Toronto=CA|America/Iqaluit=CA|America/Atikokan=CA|America/Winnipeg=CA|America/Resolute=CA|America/Rankin_Inlet=CA|America/Regina=CA|America/Swift_Current=CA|America/Edmonton=CA|America/Cambridge_Bay=CA|America/Inuvik=CA|America/Vancouver=CA|America/Creston=CA|America/Dawson_Creek=CA|America/Fort_Nelson=CA|America/Whitehorse=CA|America/Dawson=CA|Indian/Cocos=CC|Africa/Kinshasa=CD|Africa/Lubumbashi=CD|Africa/Bangui=CF|Africa/Brazzaville=CG|Europe/Zurich=CH|Africa/Abidjan=CI|Pacific/Rarotonga=CK|America/Santiago=CL|America/Coyhaique=CL|America/Punta_Arenas=CL|Pacific/Easter=CL|Africa/Douala=CM|Asia/Shanghai=CN|Asia/Urumqi=CN|America/Bogota=CO|America/Costa_Rica=CR|America/Havana=CU|Atlantic/Cape_Verde=CV|America/Curacao=CW|Indian/Christmas=CX|Asia/Nicosia=CY|Asia/Famagusta=CY|Europe/Prague=CZ|Europe/Berlin=DE|Europe/Busingen=DE|Africa/Djibouti=DJ|Europe/Copenhagen=DK|America/Dominica=DM|America/Santo_Domingo=DO|Africa/Algiers=DZ|America/Guayaquil=EC|Pacific/Galapagos=EC|Europe/Tallinn=EE|Africa/Cairo=EG|Africa/El_Aaiun=EH|Africa/Asmara=ER|Europe/Madrid=ES|Africa/Ceuta=ES|Atlantic/Canary=ES|Africa/Addis_Ababa=ET|Europe/Helsinki=FI|Pacific/Fiji=FJ|Atlantic/Stanley=FK|Pacific/Chuuk=FM|Pacific/Pohnpei=FM|Pacific/Kosrae=FM|Atlantic/Faroe=FO|Europe/Paris=FR|Africa/Libreville=GA|Europe/London=GB|America/Grenada=GD|Asia/Tbilisi=GE|America/Cayenne=GF|Europe/Guernsey=GG|Africa/Accra=GH|Europe/Gibraltar=GI|America/Nuuk=GL|America/Danmarkshavn=GL|America/Scoresbysund=GL|America/Thule=GL|Africa/Banjul=GM|Africa/Conakry=GN|America/Guadeloupe=GP|Africa/Malabo=GQ|Europe/Athens=GR|Atlantic/South_Georgia=GS|America/Guatemala=GT|Pacific/Guam=GU|Africa/Bissau=GW|America/Guyana=GY|Asia/Hong_Kong=HK|America/Tegucigalpa=HN|Europe/Zagreb=HR|America/Port-au-Prince=HT|Europe/Budapest=HU|Asia/Jakarta=ID|Asia/Pontianak=ID|Asia/Makassar=ID|Asia/Jayapura=ID|Europe/Dublin=IE|Asia/Jerusalem=IL|Europe/Isle_of_Man=IM|Asia/Kolkata=IN|Indian/Chagos=IO|Asia/Baghdad=IQ|Asia/Tehran=IR|Atlantic/Reykjavik=IS|Europe/Rome=IT|Europe/Jersey=JE|America/Jamaica=JM|Asia/Amman=JO|Asia/Tokyo=JP|Africa/Nairobi=KE|Asia/Bishkek=KG|Asia/Phnom_Penh=KH|Pacific/Tarawa=KI|Pacific/Kanton=KI|Pacific/Kiritimati=KI|Indian/Comoro=KM|America/St_Kitts=KN|Asia/Pyongyang=KP|Asia/Seoul=KR|Asia/Kuwait=KW|America/Cayman=KY|Asia/Almaty=KZ|Asia/Qyzylorda=KZ|Asia/Qostanay=KZ|Asia/Aqtobe=KZ|Asia/Aqtau=KZ|Asia/Atyrau=KZ|Asia/Oral=KZ|Asia/Vientiane=LA|Asia/Beirut=LB|America/St_Lucia=LC|Europe/Vaduz=LI|Asia/Colombo=LK|Africa/Monrovia=LR|Africa/Maseru=LS|Europe/Vilnius=LT|Europe/Luxembourg=LU|Europe/Riga=LV|Africa/Tripoli=LY|Africa/Casablanca=MA|Europe/Monaco=MC|Europe/Chisinau=MD|Europe/Podgorica=ME|America/Marigot=MF|Indian/Antananarivo=MG|Pacific/Majuro=MH|Pacific/Kwajalein=MH|Europe/Skopje=MK|Africa/Bamako=ML|Asia/Yangon=MM|Asia/Ulaanbaatar=MN|Asia/Hovd=MN|Asia/Macau=MO|Pacific/Saipan=MP|America/Martinique=MQ|Africa/Nouakchott=MR|America/Montserrat=MS|Europe/Malta=MT|Indian/Mauritius=MU|Indian/Maldives=MV|Africa/Blantyre=MW|America/Mexico_City=MX|America/Cancun=MX|America/Merida=MX|America/Monterrey=MX|America/Matamoros=MX|America/Chihuahua=MX|America/Ciudad_Juarez=MX|America/Ojinaga=MX|America/Mazatlan=MX|America/Bahia_Banderas=MX|America/Hermosillo=MX|America/Tijuana=MX|Asia/Kuala_Lumpur=MY|Asia/Kuching=MY|Africa/Maputo=MZ|Africa/Windhoek=NA|Pacific/Noumea=NC|Africa/Niamey=NE|Pacific/Norfolk=NF|Africa/Lagos=NG|America/Managua=NI|Europe/Amsterdam=NL|Europe/Oslo=NO|Asia/Kathmandu=NP|Pacific/Nauru=NR|Pacific/Niue=NU|Pacific/Auckland=NZ|Pacific/Chatham=NZ|Asia/Muscat=OM|America/Panama=PA|America/Lima=PE|Pacific/Tahiti=PF|Pacific/Marquesas=PF|Pacific/Gambier=PF|Pacific/Port_Moresby=PG|Pacific/Bougainville=PG|Asia/Manila=PH|Asia/Karachi=PK|Europe/Warsaw=PL|America/Miquelon=PM|Pacific/Pitcairn=PN|America/Puerto_Rico=PR|Asia/Gaza=PS|Asia/Hebron=PS|Europe/Lisbon=PT|Atlantic/Madeira=PT|Atlantic/Azores=PT|Pacific/Palau=PW|America/Asuncion=PY|Asia/Qatar=QA|Indian/Reunion=RE|Europe/Bucharest=RO|Europe/Belgrade=RS|Europe/Kaliningrad=RU|Europe/Moscow=RU|Europe/Simferopol=UA|Europe/Kirov=RU|Europe/Volgograd=RU|Europe/Astrakhan=RU|Europe/Saratov=RU|Europe/Ulyanovsk=RU|Europe/Samara=RU|Asia/Yekaterinburg=RU|Asia/Omsk=RU|Asia/Novosibirsk=RU|Asia/Barnaul=RU|Asia/Tomsk=RU|Asia/Novokuznetsk=RU|Asia/Krasnoyarsk=RU|Asia/Irkutsk=RU|Asia/Chita=RU|Asia/Yakutsk=RU|Asia/Khandyga=RU|Asia/Vladivostok=RU|Asia/Ust-Nera=RU|Asia/Magadan=RU|Asia/Sakhalin=RU|Asia/Srednekolymsk=RU|Asia/Kamchatka=RU|Asia/Anadyr=RU|Africa/Kigali=RW|Asia/Riyadh=SA|Pacific/Guadalcanal=SB|Indian/Mahe=SC|Africa/Khartoum=SD|Europe/Stockholm=SE|Asia/Singapore=SG|Atlantic/St_Helena=SH|Europe/Ljubljana=SI|Arctic/Longyearbyen=SJ|Europe/Bratislava=SK|Africa/Freetown=SL|Europe/San_Marino=SM|Africa/Dakar=SN|Africa/Mogadishu=SO|America/Paramaribo=SR|Africa/Juba=SS|Africa/Sao_Tome=ST|America/El_Salvador=SV|America/Lower_Princes=SX|Asia/Damascus=SY|Africa/Mbabane=SZ|America/Grand_Turk=TC|Africa/Ndjamena=TD|Indian/Kerguelen=TF|Africa/Lome=TG|Asia/Bangkok=TH|Asia/Dushanbe=TJ|Pacific/Fakaofo=TK|Asia/Dili=TL|Asia/Ashgabat=TM|Africa/Tunis=TN|Pacific/Tongatapu=TO|Europe/Istanbul=TR|America/Port_of_Spain=TT|Pacific/Funafuti=TV|Asia/Taipei=TW|Africa/Dar_es_Salaam=TZ|Europe/Kyiv=UA|Africa/Kampala=UG|Pacific/Midway=UM|Pacific/Wake=UM|America/New_York=US|America/Detroit=US|America/Kentucky/Louisville=US|America/Kentucky/Monticello=US|America/Indiana/Indianapolis=US|America/Indiana/Vincennes=US|America/Indiana/Winamac=US|America/Indiana/Marengo=US|America/Indiana/Petersburg=US|America/Indiana/Vevay=US|America/Chicago=US|America/Indiana/Tell_City=US|America/Indiana/Knox=US|America/Menominee=US|America/North_Dakota/Center=US|America/North_Dakota/New_Salem=US|America/North_Dakota/Beulah=US|America/Denver=US|America/Boise=US|America/Phoenix=US|America/Los_Angeles=US|America/Anchorage=US|America/Juneau=US|America/Sitka=US|America/Metlakatla=US|America/Yakutat=US|America/Nome=US|America/Adak=US|Pacific/Honolulu=US|America/Montevideo=UY|Asia/Samarkand=UZ|Asia/Tashkent=UZ|Europe/Vatican=VA|America/St_Vincent=VC|America/Caracas=VE|America/Tortola=VG|America/St_Thomas=VI|Asia/Ho_Chi_Minh=VN|Pacific/Efate=VU|Pacific/Wallis=WF|Pacific/Apia=WS|Asia/Aden=YE|Indian/Mayotte=YT|Africa/Johannesburg=ZA|Africa/Lusaka=ZM|Africa/Harare=ZW";
    ...
    async function navigateDiscussion(hash: string, localThread?: HTMLElement): Promise<void> {
        ...
        // Rendering a shorter page can clamp scrollY without any user input.
        // Only real interaction should cancel the requested navigation's focus.
        ...
        const status = (message: string, retry = false) => {
            ...
            if (!message.startsWith("Loading") && !userInterrupted &&
        ...
        try {
            ...
            if (userMoved || userInterrupted) return;
    ...
    function discussionPostHeaderHtml(note: ParticipantNote, canReply: boolean): string {
        ...
        return `<div class="lmx-discussion-post-header">
            ...
            <span class="lmx-discussion-post-actions">${discussionCopyLinkHtml(permalink, "post")}${reply}</span>
        </div>`;
    }
    ...
    function discussionReplyHtml(reply: DiscussionReply, note: Pick<ParticipantNote, "participantId" | "challengeDay" | "systemPostId">): string {
        const permalink = `${discussionPermalink(note)}/reply/${encodeURIComponent(reply.id)}`;
        const when = discussionTimeHtml(reply.createdAtUtc, permalink, "Posted");
        ...
        const author = reply.participantId === note.participantId
            ? '<span class="lmx-discussion-author-marker" title="Author of the opening post">Author</span>' : "";
        const replyAction = participantState && accessToken
            ? `<button class="lmx-discussion-quiet-action" type="button" data-discussion-reply-to
                aria-label="Reply to ${escAttr(reply.displayName)}"><i class="fas fa-reply" aria-hidden="true"></i><span>Reply</span></button>` : "";
        const ownerActions = ownsReply
            ? `<span class="lmx-discussion-reply-owner-actions" aria-label="Reply actions">
                <button type="button" data-discussion-reply-edit aria-label="Edit reply" aria-expanded="false">Edit</button>
    ...
    function discussionCopyLinkHtml(permalink: string, kind: "post" | "reply"): string {
        return `<button class="lmx-discussion-quiet-action lmx-discussion-copy-link" type="button"
            data-discussion-copy-link="${escAttr(permalink)}" aria-label="Copy link to this ${kind}" title="Copy link">
            <i class="fas fa-link" aria-hidden="true"></i></button>`;
    }

    async function copyDiscussionLink(button: HTMLButtonElement): Promise<void> {
        if (button.getAttribute("aria-busy") === "true") return;
        const url = new URL(button.dataset.discussionCopyLink || "/longevitymaxxing", window.location.origin).href;
        const scope = button.closest<HTMLElement>(".lmx-discussion-reply-item, article[data-discussion-post-participant-id]");
        if (!scope) return;
        let feedback = scope.querySelector<HTMLElement>(":scope > .lmx-discussion-copy-feedback");
        if (!feedback) {
            feedback = document.createElement("div");
            feedback.className = "lmx-discussion-copy-feedback";
            feedback.setAttribute("role", "status");
            scope.querySelector(".lmx-discussion-reply-footer, .lmx-discussion-post-header")?.after(feedback);
        }
        feedback.replaceChildren();
        feedback.classList.remove("error");
        const attempt = createDiscussionReplyId();
        button.dataset.discussionCopyAttempt = attempt;
        ...
        try {
            ...
            window.setTimeout(() => {
                if (button.dataset.discussionCopyAttempt !== attempt) return;
                icon.className = "fas fa-link";
                button.title = "Copy link";
            ...
            feedback.textContent = "Select and copy this link.";
            const input = document.createElement("input");
            input.type = "text";
            input.readOnly = true;
            input.value = url;
            input.setAttribute("aria-label", "Public discussion link");
            input.addEventListener("focus", () => input.select());
            feedback.append(input);
            if (document.activeElement === button) input.focus({ preventScroll: true });
        } finally {
    ...
    function wireDiscussionControls(root: ParentNode): void {
        ...
        root.querySelectorAll<HTMLButtonElement>("[data-discussion-copy-link], [data-discussion-reply-to]").forEach(button => {
            ...
            button.dataset.discussionControlWired = "true";
            button.addEventListener("click", () => {
                if (button.hasAttribute("data-discussion-copy-link")) void copyDiscussionLink(button);
                else replyToDiscussionComment(button);
            });
        });
        ...
        root.querySelectorAll<HTMLButtonElement>("[data-discussion-reply-edit]").forEach(button => {
            if (button.dataset.discussionControlWired === "true") return;
            button.dataset.discussionControlWired = "true";
            button.addEventListener("click", () => openDiscussionReplyEditor(button));
        });
        root.querySelectorAll<HTMLButtonElement>("[data-discussion-reply-delete]").forEach(button => {
            if (button.dataset.discussionControlWired === "true") return;
            button.dataset.discussionControlWired = "true";
    ...
    function replyToDiscussionComment(button: HTMLButtonElement): void {
        const replyId = button.closest<HTMLElement>("[data-discussion-reply-id]")?.dataset.discussionReplyId || "";
        ...
        const opener = thread?.querySelector<HTMLButtonElement>("[data-discussion-reply]");
        if (!reply || !opener || !participantState || !accessToken) return;
        const key = discussionDraftKey(opener);
        if (activeDiscussionDraft?.key !== key || activeDiscussionDraft.surface !== discussionDraftSurface(button))
            openDiscussionDraft(opener, null);
        ...
        if (discussionMutation !== key && reply.participantId !== participantState.participant.id) {
            ...
            const recipient = participants.find(row => row.participantId === reply.participantId);
            const unique = recipient && participants.filter(row =>
                row.displayName.trim().toLocaleLowerCase() === recipient.displayName.trim().toLocaleLowerCase()).length === 1;
            const mentioned = mentionedParticipantIds(draft.body, mentionableParticipants());
            if (!unique) draft.notice = "A unique @mention isn’t available for this participant.";
            else if (!mentioned.has(reply.participantId)) {
                const prefix = `@${recipient.displayName} `;
                if (mentioned.size >= MAX_NOTE_MENTIONS) draft.notice = "Five-participant mention limit reached. Your draft is unchanged.";
                else if (draft.body.length + prefix.length > 240) draft.notice = "Make room in your draft to add this @mention.";
                else {
                    draft.body = prefix + draft.body;
                    draft.selectionStart += prefix.length;
                    draft.selectionEnd += prefix.length;
                    if (draft.body.trim() !== draft.submittedBody) draft.error = null;
    ...
    function findDiscussionReply(replyId: string): DiscussionReply | null {
        if (!replyId) return null;
        for (const cache of discussionReplyCache.values()) {
    ...
    function participantAvatarDetails(
        row: LeaderboardRow | null,
        displayName: string
    ): { image: string; hasProfileImage: boolean; alt: string } {
        const athlete = row ? findAthleteForParticipant(row) : null;
    ...
    async function postJson(url: `${typeof API}/discussion/replies/edit`, payload: object): Promise<DiscussionReply>;
    async function postJson(
        url: `${typeof API}/edit` | `${typeof API}/participant` | `${typeof API}/check-in` | `${typeof API}/discussion/replies` | `${typeof API}/discussion/replies/delete`,
        payload: object
    ...
    async function postJson(url: string, payload: object): Promise<unknown> {
        ...
        if (url === `${API}/discussion/replies/edit` && !isDiscussionReply(data)) throw invalidApiResponse(url);
        if ((url === `${API}/edit` || url === `${API}/participant` || url === `${API}/check-in` || url === `${API}/discussion/replies` || url === `${API}/discussion/replies/delete`) && !isParticipantState(data)) {
    ...
    function getAvailableTimeZones(current: string): string[] {
        const zones = getRuntimeTimeZones().map(preferredTimeZoneId);
        const sorted = Array.from(new Set(["UTC", ...zones]))
            .filter(Boolean)
            .sort((a, b) => a.localeCompare(b));
        return Array.from(new Set([preferredTimeZoneId(current || "UTC"), ...sorted]));
    }
    ...
    function preferredTimeZoneId(zone: string): string {
        const candidate = zone || "UTC";
        return getPreferredTimeZoneIds().get(candidate) || candidate;
    }

    function getPreferredTimeZoneIds(): Map<string, string> {
        if (!preferredTimeZoneIds) {
            const runtimeTimeZones = new Set(getRuntimeTimeZones());
            preferredTimeZoneIds = new Map<string, string>();
            for (const preferredId of getTimeZoneCountryCodes().keys()) {
                if (runtimeTimeZones.has(preferredId)) continue;
                const runtimeId = resolveTimeZoneId(preferredId);
                if (runtimeId && runtimeId !== preferredId && runtimeTimeZones.has(runtimeId)) {
                    preferredTimeZoneIds.set(runtimeId, preferredId);
                }
            }
        }
        return preferredTimeZoneIds;
    }

    function resolveTimeZoneId(zone: string): string {
        try {
    ...
    function getBrowserTimeZone(): string {
        return preferredTimeZoneId(Intl.DateTimeFormat().resolvedOptions().timeZone || "UTC");
    }

    function setSelectValue(select: HTMLSelectElement, value: string): void {
        const candidate = preferredTimeZoneId(value || "UTC");
    ...
    function timeZoneDisplayName(zone: string): string {
        if (!zone) return "UTC";
        const preferredZone = preferredTimeZoneId(zone);
        const parts = String(preferredZone).split("/");
        const city = (parts[parts.length - 1] || preferredZone).replace(/_/g, " ");
        const country = timeZoneCountryLabel(preferredZone, false).split(", ")[0] || "";
        return country ? `${city}, ${country}` : city;
    }

    function timeZoneCountryLabel(zone: string, includeAll: boolean): string {
        const codes = getTimeZoneCountryCodes().get(preferredTimeZoneId(zone)) || [];
        const names = codes
            .map(code => {
                try {
