...
public sealed class PublicDataSchemaDescriptions : ISchemaFilter
{
    public void Apply(IOpenApiSchema schema, SchemaFilterContext context)
    {
        ...
        {
            openApiSchema.Description = "Mandatory non-participation disclosure, sourced notability context, licensed portrait attribution and reviewed provenance for an unranked OpenData profile.";
        }
        else if (context.Type == typeof(PublicOpenDataPortraitApiDocument))
        {
            openApiSchema.Description = "Required portrait attribution from the publishing source. AssetUrl is generated by the service only after the local WebP passes file, format and dimension validation.";
        }
